...
export function PhotoCameraSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-background py-8 lg:py-12 border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* En-tête */}
        <div className="flex items-end justify-between mb-6">
          <div>
            <span className="inline-flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-red-600 dark:text-red-400">
...
function ProductCard({
  ...
  return (
    <Link href={`/products/${product.id}`} className="group">
      <div className="relative overflow-hidden rounded-lg bg-surface border border-border transition-all duration-500 group-hover:border-red-500/30 group-hover:shadow-lg group-hover:shadow-red-500/5">
