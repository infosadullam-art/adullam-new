  ...
  const DesktopHero = () => (
    ...
    >
      <div className="max-w-7xl mx-auto px-8 pt-8 pb-2">
        ...
        >
          <div
            className="trust-track flex"
            style={{ width: "200%", paddingTop: "16px", paddingBottom: "16px" }}
          >
            {[...trustItems, ...trustItems].map(({ icon: Icon, label, sub }, i) => (
              <div
                ...
                style={{ 
                  width: `${100 / (trustItems.length * 2)}%`,
                  boxSizing: "border-box",
                  padding: "0 32px",
                  borderRight: i < trustItems.length * 2 - 1 ? "0.5px solid rgba(0,0,0,0.1)" : "none",
                }}
              >
                <div 
                  className="p-2"
          ...
          <style jsx>{`
            .trust-track {
              animation: trustScroll 9s cubic-bezier(0.65, 0, 0.35, 1) infinite;
