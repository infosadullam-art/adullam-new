        ...
        <div className="px-4 py-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 animate-pulse" style={{ background: "#F4F4F4", borderRadius: "6px" }} />
              <div>
          ...
          <div className="flex gap-3 overflow-hidden">
            {[0,1,2,3].map(i => (
              <div key={i} className="flex-shrink-0 w-[130px]" style={{ border: "0.5px solid #ECECEC", borderRadius: "6px", overflow: "hidden" }}>
      ...
      <div className="px-4 py-4">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 style={{ fontSize: "13px", fontWeight: 700, color: "#0A0A0A", fontFamily: amazonFont, lineHeight: 1.2 }}>
                Meilleures ventes
              </h2>
          ...
          <Link
            ...
            className="flex items-center gap-0.5 text-xs font-semibold transition-all duration-200 hover:gap-1"
        ...
        >
          {products.map((product, index) => (
            <Link
              ...
              className="group block flex-shrink-0 transition-all duration-200 hover:-translate-y-1"
              style={{ width: "130px" }}
            >
              <div
              ...
              >
                ...
                <div className="px-2 py-2">
                  <p
                    ...
                    style={{ fontSize: "11px", fontWeight: 500, color: "#0A0A0A", fontFamily: amazonFont }}
                  >
                    {product.name}
                  </p>
                  <p
                    style={{ fontSize: "13px", fontWeight: 700, color: "#D4372B", fontFamily: amazonFont }}
                  >
        ...
        <div className="flex items-center justify-center gap-1 mt-2">
          ...
          <span style={{ fontSize: "9px", color: "#AAAAAA", marginLeft: "4px", fontFamily: amazonFont }}>glissez →</span>
        </div>
      </div>
