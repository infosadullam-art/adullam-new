...
export function Header() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      if (e.clientY < 60) {
        // Annule le timeout de disparition
        ...
        // Programme la disparition après 2 secondes si on a scrollé
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        {/* BARRE NOIRE - Utilisation de translateY pour un glissement fluide */}
        <div 
          className="hidden lg:block transition-all duration-400 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
          style={{ 
            background: "#0A0A0A",
      ...
      <div className={`hidden lg:block transition-all duration-400 ${isNavBarVisible ? 'h-[130px]' : 'h-[70px]'}`} />
