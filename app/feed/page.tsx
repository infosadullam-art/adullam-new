    ...
    <div className="min-h-screen bg-neutral-light pb-20 lg:pb-0">
      ...
      <main className="max-w-[1440px] mx-auto px-4 lg:px-6 py-6 relative">
        ...
        <div className="relative">
          ...
          {/* Overlay animé professionnel */}
          <div className={`absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-white/95 to-white/90 backdrop-blur-md rounded-2xl transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {/* Animation de particules / cercle pulsant */}
            <div className="relative mb-6">
              <div className="absolute inset-0 rounded-full bg-[#C72C1C]/20 animate-ping" style={{ animationDuration: '1.5s' }}></div>
              <div className="absolute inset-0 rounded-full bg-[#C72C1C]/10 animate-pulse" style={{ animationDuration: '2s' }}></div>
            ...
            {/* Texte animé */}
            <h2 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-[#C72C1C] to-[#E85D4C] bg-clip-text text-transparent mb-3 animate-pulse">
              Bientôt disponible
            </h2>
            ...
            <button 
              ...
              className="group relative px-8 py-3 bg-white border-2 border-[#C72C1C] text-[#C72C1C] rounded-full font-medium overflow-hidden transition-all hover:bg-[#C72C1C] hover:text-white hover:shadow-lg"
            >
