...
import { Eye, Package, User, CheckCircle, RefreshCw } from "lucide-react"
...
export default function SourcingResponsesPage() {
  ...
  const loadRequests = async () => {
    ...
    try {
      ...
      console.error("Failed to load responded requests:", error)
  ...
  return (
    <div>
      <AdminHeader
        ...
        description="Demandes auxquelles vous avez répondu"
        actions={
      ...
      <div className="p-6">
        <div className="mb-4 flex items-center gap-4">
          <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 px-3 py-1">
            ...
            {meta?.total || 0} demandes répondues
          </Badge>
        ...
        <DataTable
          ...
          emptyMessage="Aucune réponse envoyée"
